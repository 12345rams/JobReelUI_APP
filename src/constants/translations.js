export const translations = {
  en: {
    ...
    useMyLocation: 'Use GPS', locationSet: 'Location set', comments: 'Comments',
  ...
  hi: {
    ...
    useMyLocation: 'GPS', locationSet: 'स्थान सेट', comments: 'टिप्पणियाँ',
    loginFailed: 'लॉगिन विफल', registerFailed: 'पंजीकरण विफल',
  },
  mr: {
    ...
    useMyLocation: 'GPS', locationSet: 'ठिकाण सेट', comments: 'टिप्पण्या',
    loginFailed: 'लॉगिन अयशस्वी', registerFailed: 'नोंदणी अयशस्वी',
  }
};
...
export const categoryTranslations = {
  ...
  hi: {
    ...
    'DATA_ENTRY': 'डेटा एंट्री / कंप्यूटर ऑपरेटर', 'OFFICE_BOY': 'ऑफेस बॉय / चपरासी', 'RECEPTIONIST': 'रिसेप्शनिस्ट',
  ...
  mr: {
    ...
    'DATA_ENTRY': 'डेटा एंट्री / संगणक ऑपरेटर', 'OFFICE_BOY': 'ऑफेस बॉय / शिपाई', 'RECEPTIONIST': 'रिसेप्शनिस्ट',
...
export const educationLevels = [
  { value: '', label: { en: 'All Education', hi: 'सभी शिक्षा', mr: 'सर्व शिक्षण' } },
  { value: 'CLASS_1_5', label: { en: 'Class 1-5', hi: 'कक्षा 1-5', mr: 'इयत्ता 1-5' } },
  { value: 'CLASS_6_8', label: { en: 'Class 6-8', hi: 'कक्षा 6-8', mr: 'इयत्ता 6-8' } },
  { value: 'CLASS_9_10', label: { en: 'Class 9-10', hi: 'कक्षा 9-10', mr: 'इयत्ता 9-10' } },
  { value: 'CLASS_11_12', label: { en: 'Class 11-12', hi: 'कक्षा 11-12', mr: 'इयत्ता 11-12' } },
  { value: 'DIPLOMA', label: { en: 'Diploma / ITI', hi: 'डिप्लोमा / ITI', mr: 'डिप्लोमा / ITI' } },
  { value: 'GRADUATE', label: { en: 'Graduate (BA/BSc/BCom)', hi: 'स्नातक (BA/BSc/BCom)', mr: 'पदवीधर (BA/BSc/BCom)' } },
  { value: 'BTECH', label: { en: 'B.Tech / Engineering', hi: 'बी.टेक / इंजीनियरिंग', mr: 'बी.टेक / अभियांत्रिकी' } },
  { value: 'MEDICAL', label: { en: 'Medical / Nursing', hi: 'मेडिकल / नर्सिंग', mr: 'वैद्यकीय / नर्सिंग' } },
  { value: 'CA', label: { en: 'CA / CS / ICWA', hi: 'CA / CS / ICWA', mr: 'CA / CS / ICWA' } },
  { value: 'MBA', label: { en: 'MBA / PGDM', hi: 'MBA / PGDM', mr: 'MBA / PGDM' } },
  { value: 'PHD', label: { en: 'PhD / Doctorate', hi: 'PhD / डॉक्टरेट', mr: 'PhD / डॉक्टरेट' } },
  { value: 'NONE', label: { en: 'No Education Required', hi: 'शिक्षा आवश्यक नहीं', mr: 'शिक्षण आवश्यक नाही' } },
];
